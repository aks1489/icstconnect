                        ...
                        <div className="group">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    autoComplete="email"
                                    required
                                    className="block w-full pl-10 pr-3 py-3 border border-white/10 rounded-lg bg-black/20 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all sm:text-sm backdrop-blur-sm"
                                    placeholder="admin@icst.com"
                                    value={email}
